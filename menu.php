     ...
     <div class="row">
       <div class="col-md-5">
         <div id="list-example" class="list-group">
           <a class="list-group-item list-group-item-action" href="javascript:buscar(0,10,2)">
           ...
           <a class="list-group-item list-group-item-action" href="javascript:buscar(0,6,2)">
  ...
  <div class="row">
   <div class="col">
     <div class="row">
       <div class="col-md-4">
         <div id="list-example" class="list-group">
           <a class="list-group-item list-group-item-action" href="javascript:buscar(0,4,2)">
...
function menu_ventas(){
   ...
   <div class="col">
     <div class="row">
       <div class="col-md-4">
         <div id="list-example" class="list-group">
           <a class="list-group-item list-group-item-action" href="javascript:buscar(0,11,2)">
